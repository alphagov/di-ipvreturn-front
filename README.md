# Digital Identity Return Journey(IPR)

# di-ipvreturn-front

Frontend for the return journey. 

This is the home for the front end user interface for the return journey as part of the Identity Proofing and Verification (IPV) system within the GDS digital identity platform. Other repositories are used for core services or other credential issuers.
